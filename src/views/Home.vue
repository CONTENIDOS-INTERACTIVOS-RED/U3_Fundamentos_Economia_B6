          ...
          .row.g-0
            ...
            .col-xl-6.info-section
              .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
                ...
                p.descripcion.mb-4 Desde sus inicios, la economía ha sido una disciplina en constante evolución, desarrollando distintas corrientes de pensamiento que han influido en la manera en que los países gestionan sus recursos y políticas económicas. Desde la escuela clásica hasta enfoques contemporáneos como la economía conductual e institucionalista, cada modelo ha aportado herramientas clave para comprender los mercados y la toma de decisiones económicas.
                
                p #[b ¡Prepárese para interpretar el contexto económico con una visión crítica y fundamentada!]
